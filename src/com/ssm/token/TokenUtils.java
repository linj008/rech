...
//        解析token
  ...
  //解析password
    public static Map<String,Object> validPwdHS256(String password) throws ParseException, JOSEException {
//        解析token
        JWSObject jwsObject = JWSObject.parse(password);
        //建立一个解锁密匙
        JWSVerifier jwsVerifier = new MACVerifier(secret);
        return verifyPassword(jwsObject, jwsVerifier);
    }
     ...
     */
    private static Map<String,Object> verifyPassword(JWSObject jwsObject,JWSVerifier jwsVerifier) throws JOSEException {
        Map<String, Object> resultMap = new HashMap<>();
        //获取到载荷
        Payload payload=jwsObject.getPayload();
        //判断token
