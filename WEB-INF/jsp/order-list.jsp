	...
	<section class="Hui-article-box">
		...
		<div class="Hui-article">
			<article class="cl pd-20">
				<form action="orders" method="post" id="searchForm">
					<div class="text-c">
					 ...
					 状态： <select class="text" id="order_status" name="order_status">
							...
							<option value="3" <%="3".equals(status) ? "selected='selected'" : "" %>>支付过期</option>
						</select>
						<input type="text" class="input-text" style="width: 250px"
							placeholder="输入接单员" id="" name="username" value="<%=null != username ? username : "" %>">
