...
<body>
<%
	TPlatform platform = (TPlatform)request.getAttribute("platform");
%>
<article class="cl pd-20">
	<form action="addplatform" method="post" class="form form-horizontal" id="form-platform-add">
		<input type="hidden" id="pid" name="pid" value="<%=platform.getId() %>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>平台代码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="code" name="code" value="<%=platform.getPlatformCode()%>">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>平台名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="name" name="name" value="<%=platform.getName()%>">
			</div>
		</div>
		<div class="row cl">
