...
<article class="cl pd-20">
	<form action="uploadFile" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">对账中，请不要关闭页面</span></label>
		</div>
	</form>
</article>
